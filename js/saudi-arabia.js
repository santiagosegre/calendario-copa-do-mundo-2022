...
document.querySelector("#cards-saudi-arabia").innerHTML =
  createCard("22/11", "terça", createGame("argentina", "11:00", "saudi-arabia")) +
  createCard("26/11", "sábado", createGame("poland", "14:00", "saudi-arabia")) +
