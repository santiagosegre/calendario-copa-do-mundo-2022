...
function createCard(date, day, games) {
  ...
  // jogos de Portugal
document.querySelector("#cards-portugal").innerHTML =
  createCard("24/11", "quinta", createGame("portugal", "17:00", "ghana")) +
  createCard("28/11", "segunda", createGame("portugal", "20:00", "uruguay")) +
