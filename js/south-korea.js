...
document.querySelector("#cards-south-korea").innerHTML =
  createCard(
    "24/11",
    "quinta",
    createGame("CIDADE DA EDUCAÇÃO", "10:00", "uruguay", "", "", "south-korea")
  ) +
  createCard(
    "28/11",
    "segunda",
    createGame("CIDADE DA EDUCAÇÃO", "10:00", "south-korea", "", "", "ghana")
  ) +
  createCard(
    "02/12",
    "sexta",
    createGame("CIDADE DA EDUCAÇÃO", "12:00", "south-korea", "", "", "portugal")
  )
//
...
// GRUPO h
document.querySelector("#group-h").innerHTML = createGroup(
  "Grupo h",
  "portugal",
  "Portugal",
  "ghana",
